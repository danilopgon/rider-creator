      ...
      <div className="flex-1 shadow-xl card join-item bg-base-100">
        ...
        <div className="card-body">
          ...
          <div className="justify-end card-actions">
            <button onClick={()=>actions.handleRoleSubmit('musician')} className="btn btn-primary">Registrarme</button>
          </div>
        </div>
      </div>
      <div className="flex-1 shadow-xl card join-item bg-base-100">
        ...
        <div className="card-body">
          ...
          <div className="justify-end card-actions">
            <button onClick={()=>actions.handleRoleSubmit('manager')} className="btn btn-primary">Registrarmse</button>
          </div>
        </div>
      </div>
      <div className="flex-1 shadow-xl card join-item bg-base-100 ">
        ...
        <div className="card-body">
          ...
          <div className="justify-end card-actions">
            <button onClick={()=>actions.handleRoleSubmit('technician')} className="btn btn-primary">Registrarme</button>
          </div>
        </div>
      </div>
    </div>
